  ...
  return (
    ...
    >
      <div className="relative w-full min-h-dvh shrink-0 md:h-auto md:min-h-0 md:flex md:min-w-0 md:items-stretch">
        ...
        <div className="md:hidden w-full max-w-mobile mx-auto h-dvh bg-white px-5 pt-6 pb-[max(1.5rem,env(safe-area-inset-bottom))] flex flex-col overflow-hidden">
          <div className="flex items-center justify-between mb-6">
            ...
            {!isLast ? (
              <button
                type="button"
                onClick={onDone}
                className="font-sans text-[#00634f] text-[1.1rem] font-medium"
              >
                Skip
              </button>
            ) : (
          ...
          <div className="rounded-[2rem] overflow-hidden mb-6">
            <img
              src={slide.image}
              alt=""
              className="w-full aspect-[428/500] object-cover object-top"
            />
          </div>
          <h2 className="font-display font-bold text-[1.9rem] leading-[1.15] text-[#005646] mb-3">
            {slide.title}
          </h2>
          <p className="font-sans text-[1.1rem] leading-[1.35] text-[#404040] mb-7">
            {slide.sub}
          </p>
          <button
            type="button"
