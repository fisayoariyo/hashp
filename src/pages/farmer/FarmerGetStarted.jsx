...
function MobileFarmerGetStartedContent() {
  return (
    <>
      <p className="font-sans text-[17px] font-normal text-brand-text-primary">{COPY.contactHeading}</p>
      ...
      <p className="mt-6 font-sans text-[14px] leading-relaxed">
...
function DesktopFarmerRightPanel() {
  return (
    <div className="text-left">
      ...
      <p className="mt-6 font-sans text-[16px] leading-[1.45]">
        <span className="text-brand-text-secondary">{COPY.loginPrompt} </span>
        <Link to="/farmer/verify" className="font-normal text-brand-green underline underline-offset-2">
          {COPY.loginLink}
        </Link>
...
function DesktopFarmerGetStarted() {
  ...
  return (
    <div className="hidden h-dvh min-h-dvh gap-10 overflow-hidden bg-white p-5 md:flex lg:gap-14 lg:p-6 xl:gap-[72px]">
      <div className="relative h-full min-h-0 w-[42%] shrink-0 overflow-hidden rounded-3xl xl:w-[45%]">
        <img
          src={HERO_IMAGE.src}
          alt=""
