...
function DesktopFarmerGetStarted() {
  return (
    <div className="hidden h-dvh min-h-0 gap-10 bg-white p-5 md:flex lg:gap-14 lg:p-6 xl:gap-[72px]">
      <FarmerHeroPanel className="h-full min-h-0 w-[42%] shrink-0 rounded-3xl xl:w-[45%]" />

      <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-y-auto overscroll-y-contain scrollbar-hide py-6 pl-6 pr-6 lg:py-8 lg:pl-10 lg:pr-10 xl:pl-14 xl:pr-16">
        <div className="mx-auto flex w-full max-w-[500px] flex-col pb-10">
          <GoBackHomeButton />
