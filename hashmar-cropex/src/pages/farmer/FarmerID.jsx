...
import { ArrowLeft, Share2, MessageCircle, Smartphone } from "lucide-react";
  ...
  return (
    <div className="page-container">
      <div className="flex-1 px-4 pt-5 pb-28 overflow-y-auto scrollbar-hide">
        ...
        {/* Green ID Card */}
        <div className="bg-brand-green rounded-3xl p-5 flex flex-col items-center text-white mb-5">
          {/* Logo row */}
          ...
          <div className="text-center mb-3">
            <p className="text-white/60 text-xs font-sans">Full Name</p>
            <p className="font-display font-bold text-xl mt-0.5">{farmerData.name}</p>
          </div>

          {/* Farmer ID */}
          <div className="text-center mb-3">
            <p className="text-white/60 text-xs font-sans">Farmer ID</p>
            <p className="font-display font-bold text-base tracking-widest mt-0.5">{farmerData.id}</p>
          </div>

          {/* Cooperative */}
          <div className="text-center mb-4">
            <p className="text-white/60 text-xs font-sans">Corporative name</p>
          ...
          <div className="grid grid-cols-2 gap-4 w-full mb-4">
            <div>
              <p className="text-white/60 text-xs font-sans">Agent name</p>
              <p className="font-sans font-semibold text-sm mt-0.5">Adesipe Tomide</p>
            </div>
            <div>
              <p className="text-white/60 text-xs font-sans">Agent signature</p>
          ...
          <div className="flex items-center justify-center gap-6 w-full">
            <div className="text-center">
              <p className="text-white/60 text-xs font-sans">Issue date</p>
              <p className="font-display font-bold text-sm mt-0.5">20/04/2026</p>
            </div>
            <div className="w-px h-8 bg-white/30" />
            <div className="text-center">
              <p className="text-white/60 text-xs font-sans">Expiry date</p>
